...
class ProfileEditorFlowTest {
    ...
    @Test fun ownAvatarOpensViewerWithoutEnteringEdit() {
        ...
        rule.onNodeWithText("Zoom In").assertDoesNotExist()
        rule.onNodeWithText("Zoom Out").assertDoesNotExist()
        rule.onNodeWithText("Reset Zoom").assertDoesNotExist()
        rule.onNodeWithText("Download").assertDoesNotExist()
        rule.onNodeWithText("Edit profile").assertDoesNotExist()
        rule.onNodeWithContentDescription("More options").performClick()
        rule.onNodeWithText("Download").assertHasClickAction()
