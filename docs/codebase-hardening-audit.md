...
| 4d | Deleted-search and HTTPS projection correctness | Complete; deleted messages are excluded before matching any text/sender metadata and HTTPS host parsing honors the detector's case-insensitive contract; host-unit regressions and static gate pass | Pending commit |
