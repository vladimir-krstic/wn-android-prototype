...
| 4e | Cancellable media preparation | Complete; shared image preparation preserves coroutine cancellation, superseded requests cannot publish stale results, progress cleanup is generation-safe, and cancelling profile edit cancels active decoding; static gate passes | Pending commit |
