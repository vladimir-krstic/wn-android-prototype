...
| 4c | Collision-safe custom relay identity | Complete; punctuation-equivalent URL slugs receive deterministic unique IDs so row-targeted mutations remain isolated; host-unit regression and static gate pass | Pending commit |
