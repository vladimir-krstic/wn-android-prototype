...
| 4b | Process-local navigation recovery | Complete; restored signed-in routes without restored business state clear back to Welcome instead of rendering an empty screen; static gate and focused Pixel 8a graph assertion pass | Pending commit |
