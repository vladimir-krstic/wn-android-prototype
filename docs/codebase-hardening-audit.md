...
| 4a | Private-key clipboard privacy | Complete; the private-key copy path marks its clip sensitive without changing ordinary public/donation/debug copy behavior; static gate and focused Pixel 8a integration assertion pass | Pending commit |
