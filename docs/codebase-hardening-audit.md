...
| 5a | Composer attachment-menu focus | Complete; the composer-specific Material popup keeps the editor focused and the IME visible without weakening the focusable default for other menus; focused connected coverage and direct Pixel 8a inspection pass | Pending commit |
