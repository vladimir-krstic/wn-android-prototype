...
| 3a | Compose instrumentation host ownership | Complete; 15 component classes use the empty host and the mixed onboarding class is split; meaningful Pixel 8a execution improves from 7/166 to 115/166 passing | Pending commit |
