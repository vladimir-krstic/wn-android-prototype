# Android screen-brief instructions

- Create a brief only for a user-selected screen or tightly related flow.
- Start from `../templates/screen-brief.md` and remove unused prompts.
- Record product parity separately from Android presentation so iOS geometry
