...
2026-09-04: production parity B01–B04 are implemented and host-verified.
...
record evidence. Continue with B05. Q05 is resolved by the approved checked wipe
...
Lightning/profile saving; see `docs/screens/profile-media-and-lightning.md`. Latest clean gate: 244 unit tests, zero lint errors, both APKs;
